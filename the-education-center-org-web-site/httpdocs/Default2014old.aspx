...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div style="z-index: 0;">
    <embed src='http://www.theeducationcenter.org/flash/player.swf'width='480'height='270'bgcolor='undefined'allowscriptaccess='always' wmode='transparent' allowfullscreen='true'flashvars='file=http://www.theeducationcenter.org/flash/litow.flv&image=http://www.theeducationcenter.org/flash/35years.jpg'/></div></div>
...
<table border="0" cellpadding="1" cellspacing="1" style="width: 950px;">
	<tbody>
		<tr>
			<td colspan="2"><h2 style="background: #6c6c6c; color: white; padding: 6px; text-align: center;">Kids&#39; Best Friend Awards Event to Honor Tom Miers, Mayor and Mrs. George Pradel,&nbsp;and <br>Vilma and Bill Paus -&nbsp;the Owners of Braconi&#39;s Restaurant </h2></td>
		</tr>
		<tr>
			<td colspan="2"><p style="text-align: center;"><img src="/images/2014-award-winners-01.png"></p></td>
		</tr>
...
<table border="0" cellpadding="3" cellspacing="3" style="width: 900px;">
	<tbody>
		...
		<tr>
			<td style="text-align: right;"><a href="http://www.theeducationcenter.org/2014EducationCenterRSVP.pdf" target="_blank"><img src="Images/2014invite.jpg" style="text-align: center; width: 100%;"></a></td>
			<td style="text-align: left;"><p style="margin: 20px 0; color: #4baa42; font-size: 17px;">Please click image to print RSVP card <a href="http://www.theeducationcenter.org/2014EducationCenterRSVP.pdf" target="_blank" style="text-decoration: none;">OR CLICK HERE</a> and mail to:<br>
