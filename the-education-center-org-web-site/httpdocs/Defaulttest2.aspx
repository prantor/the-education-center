...
<table border="0" cellpadding="1" cellspacing="1" style="width: 950px;">
	<tbody>
		...
		<tr>
			<td><img src="Images/2014invite.jpg" style="text-align: center; width: 50%;"></td>
			<td><p style="margin: 20px 0; color: #4baa42; font-size: 17px;">Please print and send the <a href="http://www.theeducationcenter.org/2014EducationCenterRSVP.pdf" target="_blank" style="text-decoration: none;">RSVP card</a> with your check and send to:<br>
